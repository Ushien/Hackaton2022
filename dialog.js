...
dialogs = {
    ...
    "HV" : {
        "d002": ["Cela fait longtemps qu'on s'est pas vu"],
    ...
    "HT" : {
        ...
        "d053": ["Oh ! "+perso+" aimerait partager son souvenir du jour avec toi !"],
        "d054": ["Est-ce que tu as envie de l'entendre ?"],
    },
    "FV" : {
        "d002": ["Cela fait longtemps qu'on s'est pas vu"],
        "d003": ["Comment allez-vous aujourd'hui?", "Comment vous sentez-vous aujourd'hui?"],
